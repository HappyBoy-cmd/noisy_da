...
sys.path.insert(0, "/root/Messi_du/RDA_copy")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config',
                        ...
                        default='/root/Messi_du/RDA_copy/config/dann.yml')
    ...
    parser.add_argument(
        '--stats_file',
        default=
        "/root/Messi_du/RDA_copy/statistic/TCL-A2W-uniform-noisy-0.4-2022-02-22-13-37-40.pkl",
        type=str,
